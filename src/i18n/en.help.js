...
(I18N_PACKS.en=I18N_PACKS.en||{}).help=String.raw`
      ...
      <ul>
        ...
        <li><b>Keeping “2 GHz” or “F-42%” from being split across lines</b>: while editing text, <kbd>Cmd/Ctrl+Shift+Space</kbd> types a <b>no-break space</b> and <kbd>Cmd/Ctrl+Shift+Hyphen</kbd> a <b>no-break hyphen</b>, as in Word — table cells too. They look like an ordinary space and hyphen but hold the text together at line breaks; they are also the only way PowerPoint honors. <b>Where to use them</b>: when some text could be split, the status bar at the bottom shows “ℹ N spots may be split by a line break”; click it to jump to the next element and list the spots. It is only a hint; you can export without changing anything.</li>
