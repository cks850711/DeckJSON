...
1. 下載 **[`deckjson.html`](https://github.com/cks850711/DeckJSON/releases/latest/download/deckjson.html)**（永遠指向最新版）
...
介面有繁體中文與英文兩種，第一次開啟時依瀏覽器語言自動選擇，之後可在工具列的**齒輪 → 介面語言**切換。
